...
class _StatsScreenState extends State<StatsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Statistik Nutrisi', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black87)),
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              Text('Catat berat badanmu dari halaman Profil',
  ...
  LineChartData _weightChartData() {
    const mainColor = Color(0xFF2196F3); // Blue for weight
  ...
  Widget _buildTipsCard() {
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.lightbulb_outline, color: _getColorForType(_selectedType), size: 32),
