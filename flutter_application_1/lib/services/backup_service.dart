...
class BackupService {
  static Future<void> exportDataAsJson(BuildContext context) async {
    try {
      ...
      final foodsData = await db.query('foods');
      final waterData = await db.query('water');
      final weightHistoryData = await db.query('weight_history');
      ...
      final backupData = {
        ...
        'sqlite': {
          'foods': foodsData,
          'water': waterData,
          'weight_history': weightHistoryData,
        }
      };
