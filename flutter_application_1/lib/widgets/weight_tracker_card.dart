          ...
          children: [
            Row(
              ...
              children: [
                ...
                TextButton(
                  ...
                  child: Text('Log', style: TextStyle(color: theme.colorScheme.primary, fontWeight: FontWeight.bold)),
                ),
              ],
            ),
            const SizedBox(height: 8),
            Row(
              ...
              children: [
                ...
                Container(width: 1, height: 50, color: theme.dividerTheme.color ?? Colors.white24),
                Column(
                  children: [
